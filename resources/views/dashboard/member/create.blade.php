...
@section('content')
    <div class="row mb-2">
        <div class="col-12">
            <a href="{{ route('dashboard.department.show', $_GET['department_id']) }}" class="btn btn-primary btn-icon">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <p class="card-title font-weight-bold">Tambah Anggota</p>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <form action="{{ route('dashboard.member.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="/app-assets/images/icon/image.png" style="height: 256px !important; width: auto !important" class="d-block image-preview mb-1">
                                    <input type="file" name="image" class="form-control input-image" accept="image/*" required>
                                </div>
                                <div class="form-group">
