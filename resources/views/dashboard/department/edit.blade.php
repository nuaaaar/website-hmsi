        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <p class="card-title font-weight-bold">Edit Departemen</p>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <form action="{{ route('dashboard.department.update', $department->id) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control" rows="6" required>{{ $department->description }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label for="index">Index</label>
                                    <input type="number" name="index" class="form-control" value="{{ $department->index }}" required>
                                    <small class="text-muted">Berfungsi untuk mengurutkan list departement</small>
                                </div>
